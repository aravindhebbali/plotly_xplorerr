...
linely <- function(data, x, lcol = 'blue', lwidth = 1, ltype = 'plain',
                   ...
                   add_txt = FALSE, t_x, t_y, t_text, 
                   t_showarrow = FALSE, t_font = 'Arial', t_size = 10, t_col = 'blue') {
...
p <- linely(data, 'x', title = 'Line Chart', x_title = 'Year',
            y_title = 'Growth', axis_modify = TRUE, x_min = 0, 
            x_max = 7, y_min = 4, y_max = 9)
p
